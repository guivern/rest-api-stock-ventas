...
namespace rest_api_sistema_compra_venta.Migrations
{
    ...
    [Migration("20190131144525_PoblandoRoles_Migracion")]
    partial class PoblandoRoles_Migracion
    {
            ...
            modelBuilder.Entity("rest_api_sistema_compra_venta.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Activo = true,
                            Descripcion = "Rol que posee todos los permisos",
                            FechaCreacion = new DateTime(2019, 1, 31, 11, 45, 25, 203, DateTimeKind.Local).AddTicks(30),
